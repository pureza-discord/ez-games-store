...
export default function LoginModal({ isOpen, onClose }: LoginModalProps) {
  ...
  return (
    <div 
      className="fixed top-0 left-0 right-0 bottom-0 flex items-center justify-center bg-black/90 backdrop-blur-md animate-fade-in overflow-y-auto py-8"
      style={{ position: 'fixed', zIndex: 999999, margin: 0 }}
      onClick={(e) => e.target === e.currentTarget && handleClose()}
    >
      <div 
        className="bg-gradient-to-br from-bg-secondary to-bg-tertiary border-2 border-primary/40 rounded-3xl p-10 max-w-lg w-full mx-4 shadow-2xl"
