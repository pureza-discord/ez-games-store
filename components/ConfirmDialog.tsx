...
export default function ConfirmDialog() {
  ...
  return (
    <div 
      className="fixed top-0 left-0 right-0 bottom-0 z-[99999] flex items-center justify-center bg-black/80 backdrop-blur-md animate-fade-in"
      style={{ position: 'fixed', zIndex: 99999 }}
    >
      <div className="bg-bg-secondary border-2 border-primary/30 rounded-2xl p-6 max-w-md w-full mx-4 animate-scale-in shadow-2xl relative" style={{ zIndex: 100000 }}>
